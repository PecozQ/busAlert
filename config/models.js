...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  attributes: {
    ...
    updatedAt: { type: 'ref', columnType: 'timestamptz', autoCreatedAt: true },
    isActive: { type: 'boolean', defaultsTo: true },
    isDeleted: { type: 'boolean' },
    createdBy: { type: 'string', columnType: 'UUID', allowNull: true },
    updatedBy: { type: 'string', columnType: 'UUID', allowNull: true },
    extraData: { type: 'json' }
    //--------------------------------------------------------------------------
    //  /\   Using MongoDB?
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'QvnZmw/04nG7Ghxdistueh8fYZCg/q4XRv3gCbdR41k='
  },
